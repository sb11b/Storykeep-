...
- **Calendar:** Google Calendar (OAuth, calendar.events only). Tokens stay encrypted on the server. Library **Calendar** is week/month. Junior can propose an event; Confirm writes it. No Gmail.
