...
1. Automatic: API boot runs `001_junior_memory.sql` then `002_junior_projects.sql` from `_create_schema`. The container image includes `backend/migrations` at `/app/migrations`.
