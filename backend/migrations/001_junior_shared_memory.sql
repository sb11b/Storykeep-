-- Alias of 001_junior_memory.sql (same statements). Prefer that filename.
-- Junior shared chat memory — Railway Postgres
-- Reuses existing StoryKeep `users`. Does not create users or store secrets.
-- Apply: psql "$DATABASE_URL" -f backend/migrations/001_junior_memory.sql
